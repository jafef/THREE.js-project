...
new GLTFLoader().load('models/civil.glb', function (gltf) {
    let house = gltf.scene;
    house.position.set(0, 0, -30)
    scene.add(house);
    mixer = new THREE.AnimationMixer(house);
    const clips = gltf.animations;
    const clip = THREE.AnimationClip.findByName(clips, 'Action01');
 ...
 //new GLTFLoader().load('models/tcs.glb', function (gltf) {
 //    let house = gltf.scene;
 //    house.position.set(10, 0, 30)
 //    scene.add(house);
 // 
 //
 //});
